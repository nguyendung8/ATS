    ...
    public function run()
    {
        ...
        MailTemplate::create([
            ...
            'content' => 'Dear Mr/Ms. [CANDIDATE_NAME],<br><br>Thank you very much for your attendance at our
                ...
                We hope to keep contact with you and do look forward to further co-operation in the future.<br><br>Thank you.',
        ]);
        MailTemplate::create([
        ...
        MailTemplate::create([
            ...
            'content' => 'Dear [CANDIDATE_NAME],<br><br>Thay mặt ATS, cảm ơn bạn đã dành thời gian
                ...
                toàn xã hội.<br><br>Mong sớm nhận được hồi âm từ bạn.<br>Cảm ơn bạn.',
        ]);
        MailTemplate::create([
            ...
            'content' => 'Dear Mr/Ms. [CANDIDATE_NAME],<br><br>Thank you very much for taking the time to apply
                ...
                from you soon.<br><br>Thank you and have a good day.<br><br>Sincerely.',
        ]);
    }
}
